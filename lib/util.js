...
/*jshint -W027*/
import { existsSync, readFileSync, writeFileSync, writeFile, unlinkSync } from 'fs';
...
export const writeToFile = (outputFilename, content = []) => {
  writeFile(outputFilename, JSON.stringify(content));
